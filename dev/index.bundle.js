...
var LoaderStage_1 = __webpack_require__(14);
var LocalStorage_1 = __webpack_require__(50);
var WebsocketConnect_1 = __webpack_require__(51);
var Data_1 = __webpack_require__(52);
var StageManager_1 = __webpack_require__(2);
var EntryPoint = (function () {
    function EntryPoint() {
        ...
        this._loader = new LoaderStage_1.LoaderStage();
        this._stageManager.create();
        this._stageManager.createScene("LoaderStage", this._loader);
        this._stageManager.goToScene("LoaderStage");
    }
    EntryPoint.prototype.createWebSocket = function () {
        this._websocket = new WebsocketConnect_1.WebsocketConnect();
        this._websocket.connectWebSocket();
        this._data = new Data_1.Data(this);
    };
    Object.defineProperty(EntryPoint.prototype, "localStorage", {
        get: function () {
    ...
    Object.defineProperty(EntryPoint.prototype, "data", {
        get: function () {
            return this._data;
        },
        enumerable: true,
    ...
    Object.defineProperty(EntryPoint.prototype, "sound", {
        get: function () {
    ...
    Object.defineProperty(EntryPoint.prototype, "websocket", {
        get: function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.wellPlayerTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 35,
    fill: "#000000",
    align: "center",
});
exports.creditsTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 26,
    fill: "#1f140a",
    align: "center",
});
exports.ballTextStyle = new PIXI.TextStyle({
    fontFamily: "Topaz-8-remake",
    fontSize: 20,
    fill: "#000000",
    align: "center",
});
exports.betTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 26,
    fill: "#1f140a",
    align: "left",
});
exports.winTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 26,
    fill: "#1f140a",
    align: "center",
});
exports.spotsTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 26,
    fill: "#1f140a",
    align: "center",
});
exports.hitTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 26,
    fill: "#1f140a",
    align: "center",
});
exports.gameResultTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 26,
    fill: "#1f140a",
    align: "center",
});
exports.makeBetTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 35,
    fill: "#1f140a",
    align: "center",
});
exports.errorTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 35,
    fill: "#000000",
    align: "center",
});
exports.numbersTextStyle = ({
    fontFamily: "Topaz-8-remake",
    fontSize: 16,
    fill: "#f7f82e",
    align: "center",
});
exports.PLAYACTION = "play";
exports.TAKEWIN = "takewin";
exports.EXTRABALL = "extraball";
exports.INIT = "init";
exports.ERROR = "error";
exports.fakeKey = {
...
var GameSettings = (function () {
    ...
    GameSettings.resolvePlayAccessinble = function (value) {
        if (value >= 2 && value <= 10)
            GameSettings.playAccessible = true;
        else
            GameSettings.playAccessible = false;
    };
    GameSettings.resolveBetAccessible = function (value) {
        if (value >= 2 && value <= 10)
            GameSettings.betAccessible = true;
        else
            GameSettings.betAccessible = false;
    };
    GameSettings.resolveEligibleNumbers = function (value) {
        if (value < 10)
            GameSettings.isEligibleNumbers = true;
        else
            GameSettings.isEligibleNumbers = false;
    };
    GameSettings.maxEligibleNumber = 10;
    GameSettings.playAccessible = false;
    GameSettings.isEligibleNumbers = true;
    GameSettings.betAccessible = false;
    GameSettings.takeWinAccessible = false;
    GameSettings.extraBallStateAccessible = false;
    return GameSettings;
}());
...
Object.defineProperty(exports, "__esModule", { value: true });
var pixi_app_wrapper_1 = __webpack_require__(4);
var StageManager = (function (_super) {
    ...
    StageManager.prototype.create = function () {
        var canvas = pixi_app_wrapper_1.Dom.getElementOrCreateNew("app-canvas", "canvas", document.getElementById("app-root"));
        var appOptions = {
            width: 1024,
            height: 768,
    ...
    StageManager.prototype.drawScreenBorder = function (width) {
    ...
    StageManager.prototype.onResizeEnd = function (args) {
        if (args.stage.orientation.changed) {
            this.relocateViews();
        }
    };
    StageManager.prototype.relocateViews = function () {
        this.drawScreenBorder();
    };
...
var EntryPoints = new EntryPoint_1.EntryPoint();
...
var StageManager_1 = __webpack_require__(2);
var AssetsLoader_1 = __webpack_require__(36);
var EntryPoint_1 = __webpack_require__(0);
...
var LoaderStage = (function (_super) {
    ...
    function LoaderStage() {
        var _this = _super.call(this) || this;
        _this._game = EntryPoint_1.EntryPoint.instance;
        return _this;
    }
    LoaderStage.prototype.awake = function () {
        ...
        this._assetLoader = new AssetsLoader_1.AssetsLoader();
    ...
    LoaderStage.prototype.completeLoadAsset = function () {
        this._game.stageManager.createScene("BaseGame", new BaseGame_1.BaseGame);
    ...
    LoaderStage.prototype.loadingAnimation = function () {
        ...
        var loadingAnimation = gsap_1.TweenMax.to(this._loadingSprite, 90, {
...
var PIXI = __webpack_require__(18);
var screenfull = __webpack_require__(19);
var media_info_viewer_1 = __webpack_require__(20);
var align_bottom_center_1 = __webpack_require__(22);
var align_bottom_left_1 = __webpack_require__(23);
var align_bottom_right_1 = __webpack_require__(24);
var align_middle_1 = __webpack_require__(25);
var align_middle_left_1 = __webpack_require__(26);
var align_middle_right_1 = __webpack_require__(27);
var align_top_center_1 = __webpack_require__(28);
var align_top_left_1 = __webpack_require__(29);
var align_top_right_1 = __webpack_require__(30);
var scale_full_size_1 = __webpack_require__(31);
var scale_keep_aspect_ratio_1 = __webpack_require__(32);
var scale_none_1 = __webpack_require__(33);
...
Object.defineProperty(exports, "__esModule", { value: true });
var AlignTopLeft = (function () {
    function AlignTopLeft() {
    }
    AlignTopLeft.prototype.align = function (width, height, containerWidth, containerHeight) {
        return { x: 0, y: 0 };
    };
    return AlignTopLeft;
}());
...
Object.defineProperty(exports, "__esModule", { value: true });
var pixi_assets_loader_1 = __webpack_require__(37);
...
var AssetsLoader = (function (_super) {
    ...
    function AssetsLoader() {
        var _this = _super.call(this) || this;
        _this._assetsCount = {};
        _this._soundManager = new SoundManager_1.default();
        _this._soundCount = 0;
        _this._doubleCheck = false;
        _this.isSoundLoaded = false;
        _this._soundManager.on("sound", _this.onSoundManager, _this);
        _this.loadAssets();
        return _this;
    }
    AssetsLoader.prototype.onSoundManager = function (value) {
        switch (value) {
            case "create":
    ...
    AssetsLoader.prototype.loadAssets = function () {
        var _this = this;
        var assets = [
            { id: "Topaz-8-remake", url: "assets/fonts/stylesheet.css", priority: pixi_assets_loader_1.AssetPriority.HIGHEST, type: "fonts" },
            { id: "loading", url: "assets/gfx/loading.png", priority: pixi_assets_loader_1.AssetPriority.HIGHEST, type: "texture" },
            { id: "rectangle_yellow", url: "assets/gfx/rectangle_yellow.png", priority: pixi_assets_loader_1.AssetPriority.HIGHEST, type: "texture" },
            { id: "okay", url: "assets/gfx/okay.png", priority: pixi_assets_loader_1.AssetPriority.NORMAL, type: "texture" },
            { id: "yellowBall", url: "assets/gfx/yellowBall.png", priority: pixi_assets_loader_1.AssetPriority.NORMAL, type: "texture" },
            { id: "redBall", url: "assets/gfx/redBall.png", priority: pixi_assets_loader_1.AssetPriority.NORMAL, type: "texture" },
            { id: "blueBall", url: "assets/gfx/blueBall.png", priority: pixi_assets_loader_1.AssetPriority.NORMAL, type: "texture" },
            { id: "blackBall", url: "assets/gfx/blackBall.png", priority: pixi_assets_loader_1.AssetPriority.NORMAL, type: "texture" },
            { id: "bingo_back", url: "assets/gfx/bingo_back.png", priority: pixi_assets_loader_1.AssetPriority.NORMAL, type: "texture" },
            { id: "theme", url: "assets/sfx/theme.mp3", priority: pixi_assets_loader_1.AssetPriority.LOW, autoplay: false, loop: false, mute: false, rate: 1, type: "sound" },
            { id: "balldown", url: "assets/sfx/balldown.mp3", priority: pixi_assets_loader_1.AssetPriority.LOW, autoplay: false, loop: false, mute: false, rate: 1, type: "sound" },
            { id: "button", url: "assets/sfx/button.mp3", priority: pixi_assets_loader_1.AssetPriority.NORMAL, autoplay: false, loop: false, mute: false, rate: 1, type: "sound" },
            { id: "rectangle", url: "assets/gfx/rectangle.png", priority: pixi_assets_loader_1.AssetPriority.NORMAL, type: "texture" },
        ];
    ...
    AssetsLoader.prototype.onAssetsLoaded = function (args) {
        ...
        args.assets.forEach(function (loadAsset) {
            if (loadAsset.asset.type == "sound") {
                _this._soundManager.addSound(loadAsset, _this._soundCount);
            }
    ...
    Object.defineProperty(AssetsLoader.prototype, "soundManager", {
        get: function () {
    ...
    Object.defineProperty(AssetsLoader.prototype, "isSoundLoaded", {
        get: function () {
...
var PriorityQueue_1 = __webpack_require__(39);
...
var Heap_1 = __webpack_require__(40);
...
var arrays = __webpack_require__(41);
var Heap = (function () {
...
var SoundManager = (function (_super) {
    ...
    function SoundManager() {
        var _this = _super.call(this) || this;
        _this._sounds = {};
        _this._loadedSoundCount = 0;
        return _this;
    }
    SoundManager.prototype.addSound = function (loadAsset, length) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var EntryPoint_1 = __webpack_require__(0);
var UserInterfaceController_1 = __webpack_require__(46);
var AnimationController_1 = __webpack_require__(48);
...
var BaseGame = (function (_super) {
    ...
    BaseGame.prototype.awake = function () {
        ...
        this._animationController = new AnimationController_1.AnimationController();
    ...
    BaseGame.prototype.onAnimationHandler = function (action, type) {
        switch (action) {
            ...
            case "balldownanimationcomplete":
                ...
                this._userInterfaceController.selectedNumber.forEach(function (value) {
                    ...
                    if (type == value) {
                        cloneThis_1._userInterfaceController.interface.changeNumbersFrameColor(type);
                    }
                });
                break;
        }
    };
    BaseGame.prototype.onControlHandler = function (action, type) {
        switch (action) {
            case "startgame":
                this._game.websocket.websocketRequest("play", { bet: 1, selectedBalls: this._userInterfaceController.selectedNumber, session: "blabla" });
                break;
            case "clearinterface":
                this._animationController.clearAnimation();
                this._userInterfaceController.clearUserInterface();
                break;
            case "extraball":
                if (this._game.localStorage.getItem("ExtraBall") == "true") {
                    this._animationController.clearAnimation();
                    this._game.websocket.websocketRequest("extraball", { bet: 1, selectedBall: [1, 2, 3, 4], session: "blabla" });
                }
                break;
        }
    };
    BaseGame.prototype.onWebsocketResponse = function (data) {
        switch (data.Action) {
            case GameSettings_1.PLAYACTION:
                ...
                this._game.localStorage.setItem("Hits", data.HitNumber);
                this._game.localStorage.setItem("LastBet", data.Bet);
...
Object.defineProperty(exports, "__esModule", { value: true });
var UserInterface_1 = __webpack_require__(47);
var EntryPoint_1 = __webpack_require__(0);
var GameSettings_1 = __webpack_require__(1);
var UserInterfaceController = (function (_super) {
    ...
    function UserInterfaceController() {
        var _this = _super.call(this) || this;
        _this._selectedNumberCount = 0;
        _this._selectedNumbers = [];
        _this._game = EntryPoint_1.EntryPoint.instance;
        _this.awake();
    ...
    UserInterfaceController.prototype.onKeyDown = function (key) {
        for (var entry in GameSettings_1.fakeKey) {
            var keyElement = GameSettings_1.fakeKey[entry];
            if (key.key == keyElement[0]) {
                console.log(1, GameSettings_1.GameSettings.isEligibleNumbers);
                if (this._selectedNumbers.indexOf(Number(keyElement[1])) == -1 && GameSettings_1.GameSettings.isEligibleNumbers == true) {
        ...
        switch (key.key) {
            case "Enter":
                if (GameSettings_1.GameSettings.playAccessible == true) {
            ...
            case "Shift":
                ...
                this._selectedNumbers = [];
                this._userInterface.selectedBall = [];
            ...
            case "ArrowUp":
                ...
                this._game.localStorage.setItem("LastBet", this.interface.betAmount);
                break;
            case "ArrowDown":
    ...
    UserInterfaceController.prototype.clearUserInterface = function () {
        for (var i = 1; i <= 10; i++) {
            for (var j = 1; j <= 8; j++) {
                ...
                if (this._userInterface.okaySprite[i][j])
                    this._userInterface.okaySprite[i][j].visible = false;
                if (this._userInterface.okaySprite[i][j])
                    this._userInterface.numberSelectText[i][j].style.fill = "#f7f82e";
            }
        }
    ...
    UserInterfaceController.prototype.setInterface = function () {
        this._userInterface.wellPlayerText.text = "WELL PLAYED !";
        this._userInterface.creditsText.text = "CREDIT\n" + this._game.localStorage.getItem("Credit");
        this._userInterface.betText.text = "LAST\nBET\n" + this._game.localStorage.getItem("LastBet");
        this._userInterface.winText.text = "WIN\n" + this._game.localStorage.getItem("Win");
        this._userInterface.spotsText.text = "SPOTS\n" + this._game.localStorage.getItem("Spots");
        this._userInterface.hitText.text = "HITS\n" + this._game.localStorage.getItem("Hits");
    };
    UserInterfaceController.prototype.onLocalStorageUpdate = function (key, value) {
        switch (key) {
            case "LastBet":
                this._userInterface.betText.text = "LAST\nBET\n" + value;
                break;
    ...
    Object.defineProperty(UserInterfaceController.prototype, "interface", {
        get: function () {
    ...
    Object.defineProperty(UserInterfaceController.prototype, "selectedNumber", {
        get: function () {
    ...
    Object.defineProperty(UserInterfaceController.prototype, "selectedNumberCount", {
        get: function () {
            return this._selectedNumberCount;
        },
        set: function (value) {
            if (this._selectedNumberCount != value) {
                GameSettings_1.GameSettings.resolveEligibleNumbers(value);
                GameSettings_1.GameSettings.resolvePlayAccessinble(value);
                GameSettings_1.GameSettings.resolveBetAccessible(value);
...
Object.defineProperty(exports, "__esModule", { value: true });
var GameSettings_1 = __webpack_require__(1);
var GameSettings_2 = __webpack_require__(1);
var gsap_1 = __webpack_require__(3);
var UserInterface = (function (_super) {
    ...
    function UserInterface() {
        var _this = _super.call(this) || this;
        _this._betAmount = 0;
        _this._userInterfaceContainer = new PIXI.Container();
        _this._machine = new PIXI.Container();
        _this._selectedBall = [];
        _this._winAnimationBall = [];
        _this._offsetX = 74;
        _this._offsetY = 57;
        _this.addChild(_this._userInterfaceContainer);
        _this._machine.name = "BingoMachine";
        _this._userInterfaceContainer.addChild(_this._machine);
        _this.awake();
        return _this;
    }
    UserInterface.prototype.awake = function () {
        ...
        this._wellPlayedText = new PIXI.Text("WELL PLAYED !", GameSettings_2.wellPlayerTextStyle);
        ...
        this._gameResultText = new PIXI.Text("GAME\nOVER", GameSettings_2.gameResultTextStyle);
        ...
        this._makeBetText = new PIXI.Text("MAKE A BET", GameSettings_2.makeBetTextStyle);
    ...
    UserInterface.prototype.createNumberText = function () {
        this._numbersText = [];
        ...
        for (var i = 1; i <= 10; i++) {
            ...
            for (var j = 1; j <= 8; j++) {
                ...
                this._numbersText[i][j] = new PIXI.Text("", GameSettings_1.numbersTextStyle);
    ...
    UserInterface.prototype.okaySpriteVisibility = function (tag, visibility) {
        var firstIndex, secondIndex;
        var convertToString = tag.toLocaleString();
    ...
    UserInterface.prototype.winAlphaAnimation = function (firstIndex, secondIndex) {
        ...
        this._numberSelectedFrame[firstIndex][secondIndex].texture = PIXI.Texture.from("rectangle_yellow");
        this._winAnimationBallTween = gsap_1.TweenMax.fromTo(this._winAnimationBall, 0.45, { alpha: 1 }, { alpha: 0, repeat: -1, ease: new gsap_1.SteppedEase(1) });
    };
    UserInterface.prototype.changeNumbersFrameColor = function (tag) {
        var firstIndex, secondIndex;
        var convertToString = tag.toLocaleString();
        if (convertToString.length == 2) {
            secondIndex = tag % 10;
            ...
            if (secondIndex == 0)
                ...
                firstIndex++;
            this._numbersText[secondIndex][firstIndex].style.fill = "#0601e1";
            ...
            this._numbersText[firstIndex][1].style.fill = "#0601e1";
        }
    };
    Object.defineProperty(UserInterface.prototype, "wellPlayerText", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "selectedBall", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "creditsText", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "betText", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "winText", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "winAnimationBall", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "okaySprite", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "spotsText", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "hitText", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "numberSelectFrame", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "numberSelectText", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "winAnimationBallTween", {
        get: function () {
    ...
    Object.defineProperty(UserInterface.prototype, "betAmount", {
        get: function () {
...
var AnimationController = (function (_super) {
    ...
    AnimationController.prototype.awake = function () {
        this._animation = new Animations_1.Animations();
        this.addChild(this._animation);
    };
    Object.defineProperty(AnimationController.prototype, "interface", {
        get: function () {
...
var BallColors;
(function (BallColors) {
    BallColors["Blue"] = "blueBall";
    BallColors["Red"] = "redBall";
    BallColors["Yellow"] = "yellowBall";
    BallColors["Black"] = "redBall";
})(BallColors || (BallColors = {}));
var Animations = (function (_super) {
    __extends(Animations, _super);
    function Animations() {
        var _this = _super.call(this) || this;
        _this._animationContainer = new PIXI.Container();
        _this._ballLeftSide = [];
        _this._ballRightSide = [];
        _this._ballLeftSideText = [];
        _this._ballRightSideText = [];
        _this._currentSideRight = false;
        _this._ballCount = 0;
        _this._game = EntryPoint_1.EntryPoint.instance;
    ...
    Animations.prototype.clearAnimation = function () {
        this.ballCount = 0;
        this._animationContainer.removeChildren();
    };
    Animations.prototype.createBall = function (count) {
        for (var i = 0; i < count; i++) {
            ...
            this._ballLeftSideText[i] = new PIXI.Text("", GameSettings_1.ballTextStyle);
            ...
            this._ballRightSideText[i] = new PIXI.Text("", GameSettings_1.ballTextStyle);
        ...
        var isExtraBallState = (count == 1) ? false : true;
        this.playBallDownAnimation(isExtraBallState, count);
    };
    Animations.prototype.setBallText = function (targetObject, i) {
        var ballNumber = JSON.parse(this._game.localStorage.getItem("Numbers"));
        targetObject.text = ballNumber[i];
    };
    Animations.prototype.resolveBallColor = function (ballValue) {
        var ballColors;
    ...
    Animations.prototype.playBallDownAnimation = function (value, counts) {
        var _this = this;
        var isExtraBallState = value;
        var count = counts;
        var targetObject = (this._currentSideRight) ? this._ballRightSide[this.ballCount] : this._ballLeftSide[this.ballCount];
        var targetPositionY = 735 - (targetObject.height * this.ballCount);
        ...
        var downAnimation = gsap_1.TweenLite.to(targetObject.position, duration, {
            y: targetPositionY, ease: gsap_1.Elastic.easeOut.config(0.65, 1),
            onStart: function () {
                _this.emit("animationstate", "balldownanimationstart");
            },
            onComplete: function () {
                if (_this.ballCount < count) {
                    var value_1 = Number(targetObject.getChildAt(0).text);
                    _this.playBallDownAnimation(isExtraBallState, counts);
                    if (_this._currentSideRight) {
                        _this.ballCount++;
                    }
                    _this._currentSideRight = !_this._currentSideRight;
                    _this.emit("animationstate", "balldownanimationcomplete", value_1);
                }
            }
        });
    };
    Object.defineProperty(Animations.prototype, "ballCount", {
        get: function () {
    ...
    Object.defineProperty(Animations.prototype, "animationContainer", {
        get: function () {
...
var host = '127.0.0.1';
var port = '8090';
var WebsocketConnect = (function (_super) {
    __extends(WebsocketConnect, _super);
    function WebsocketConnect() {
        var _this = _super.call(this) || this;
        _this._game = EntryPoint_1.EntryPoint.instance;
        return _this;
    }
    WebsocketConnect.prototype.connectWebSocket = function () {
        this.websocketConnect(protocol + "://" + host + ":" + port + "/");
    };
    WebsocketConnect.prototype.websocketConnect = function (websocketUrl) {
    ...
    WebsocketConnect.prototype.websocketOpen = function (event) {
        this.emit("status", "true");
    };
    WebsocketConnect.prototype.websocketError = function () {
        var _this = this;
        this.emit("status", "false");
        setInterval(function () {
            _this.websocketConnect(protocol + "://" + host + ":" + port + "/");
        }, 5000);
    };
    WebsocketConnect.prototype.websocketResponse = function (data) {
    ...
    WebsocketConnect.prototype.websocketRequest = function (action, requestParameters) {
        this._action = action;
    ...
    WebsocketConnect.prototype.sendPing = function () {
        var _this = this;
        setInterval(function () {
            _this._wSocket.send(JSON.stringify({ action: "ping", session: _this._session }));
        }, 5000);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var GameSettings_1 = __webpack_require__(1);
var ErrorWindow_1 = __webpack_require__(53);
var Data = (function (_super) {
    ...
    Data.prototype.initListeners = function () {
        this._game.websocket.on("error", this.onWebsocketError, this);
    };
    Data.prototype.onWebsocketError = function (data) {
        switch (data.Action) {
            case GameSettings_1.ERROR:
                this._game.localStorage.setItem("ErrorCode", data.Message);
                this._game.stageManager.createScene("ErrorWindow", new ErrorWindow_1.ErrorWindow);
...
var GameSettings_1 = __webpack_require__(1);
var EntryPoint_1 = __webpack_require__(0);
var ErrorWindow = (function (_super) {
    __extends(ErrorWindow, _super);
    function ErrorWindow() {
        var _this = _super.call(this) || this;
        _this._game = EntryPoint_1.EntryPoint.instance;
        return _this;
    }
    ErrorWindow.prototype.awake = function () {
        ...
        this._errorMessage = new PIXI.Text("A Technical Problem Has Occurred.\nPlease contact with authorized person.", GameSettings_1.errorTextStyle);
        ...
        this._errorMessageCode = new PIXI.Text("", GameSettings_1.errorTextStyle);
    ...
    ErrorWindow.prototype.killScene = function () {
    };
    ErrorWindow.reloadGame = function () {
